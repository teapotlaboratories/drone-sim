...
LABEL org.opencontainers.image.source="https://github.com/teapotlaboratories/drone-sim" \
      ...
      org.opencontainers.image.title="Drone Sim Lane A Runpod runtime"

ENV DURATION=300 \
    FASTDDS_BUILTIN_TRANSPORTS=UDPv4 \
    FERN_PROFILE=drone-sim-lane-a \
...
# this profile. All simulator UDP stays inside the Pod network namespace.
