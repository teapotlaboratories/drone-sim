#!/usr/bin/env python3
"""Record the Lane C flight test to mp4, with live telemetry burned in.
...
def main():
    ...
    while ctl.poll() is None and time.time() - t0 < 240:
        ...
        ekf = last_ekf_z()
        y = tile_h
        put(canvas, "LANE C FLIGHT TEST  ~  SITL ONLY, NOTHING REAL ARMED OR FLOWN",
