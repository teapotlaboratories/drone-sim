...
>
> This is the backlog of the **retired Gazebo baseline** — PX4 v1.16.0 + Gazebo Harmonic +
> ROS 2 Jazzy — **a stack this repo no longer contains.** Gazebo is no longer installed in
> any image, and the compose stack, the smoke test and the seeded world-overlay generator
> described below have been deleted.
>
> **Read it as evidence, never as instructions.** The file paths, image tags, container
> names, compose services and task IDs it names have been renamed or deleted, and many of
> its links no longer resolve. Every measurement is preserved unchanged and is still true of
> the run that produced it — it is not a claim about the current stack.
>
> **The repo today is one simulator: Unreal Engine 5.8 + Cosys-AirSim + PX4 SITL + ROS 2
> Jazzy.** What this document was for, and what is still worth reading it for:
> [`../README.md`](../README.md). Task-ID renames: [`../id-map.md`](../id-map.md). The repo:
> [`README.md`](../../../README.md).
