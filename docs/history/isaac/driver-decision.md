...
>
> This is the decision record for **Isaac Sim 5.1 + Pegasus Simulator**, a stack that never
> ran on this machine and that **this repo no longer contains.** Its pins, its scaffolding
> and its images are gone.
>
...
> longer resolve. Every measurement is preserved unchanged — the crash signature, the driver
> versions and the probe results are still exactly what was observed.
>
> **One part of it is still live:** the same NVIDIA driver, 610.43.03, also blocks NVENC, and
> that half is tracked in the active
> [`docs/nvenc-driver-blocker.md`](../../nvenc-driver-blocker.md).
>
...
> [`../id-map.md`](../id-map.md). The repo: [`README.md`](../../../README.md).
